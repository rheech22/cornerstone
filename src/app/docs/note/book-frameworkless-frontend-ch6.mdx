---
created: 2023-03-04 00:00:00 +0900
updated: 2026-02-14 13:24:19 +0900
title: "프레임워크 없는 프론트엔드 개발 6장"
...
![router | size="480"](./assets/book-frameworkless-ch6-router.gif)
라우터 흐름은 이렇다.

![flow | size="480"](./assets/book-frameworkless-ch6-flow.png)
## 정규식을 통한 경로 매개변수 추출
...
![params | size="480"](./assets/book-frameworkless-ch6-params.gif)
...
![history | size="480"](./assets/book-frameworkless-ch6-history.gif)
