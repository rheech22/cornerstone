...
![router](./assets/book-frameworkless-ch6-router.gif)
라우터 흐름은 이렇다.

![flow](./assets/book-frameworkless-ch6-flow.png)
## 정규식을 통한 경로 매개변수 추출
...
동작하는 매개변수 탐색  
![params](./assets/book-frameworkless-ch6-params.gif)
## 히스토리 API를 이용한 라우터
...
동작하는 히스토리 라우터  
![history](./assets/book-frameworkless-ch6-history.gif)
## 출처
