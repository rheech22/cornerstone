...
updated: 2026-02-14 13:31:35 +0900
title: "플러터 설치하고 개발환경 세팅"
tags: ["flutter", "setup", "mobile"]
---
...
![iOS 시뮬레이터 화면 | size="400"](./assets/flutter-ios_simulator.png)
...
![iOS에서 flutter run 실행 화면 | size="400"](./assets/flutter-app_ios.png)
...
![Android에서 flutter run 실행 화면 | size='400'](./assets/flutter-app_and.png)
...
![VSCode Flutter Launch Emulator 화면](./assets/flutter-emulators.png)

`Flutter: Select Device`에서는 에뮬레이터 뿐만 아니라 기본 디바이스 선택 가능

![VSCode Flutter Select Device 화면](./assets/flutter-devices.png)
...
![VSCode Flutter reload 설정 화면 | size="400"](./assets/flutter-reload.png)
...
![device_preview 패키지 미리보기 화면](./assets/flutter-preview.png)
