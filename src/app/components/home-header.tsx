...
export const HomeHeader = () => {
  ...
  return (
    <header ref={headerRef} className={cn("sticky top-0 z-20 mb-6 w-full")}>
      <div
        className={cn(
          "mx-auto flex w-full max-w-[980px] items-center justify-between noise-bg px-4 py-3 backdrop-blur-sm ",
          "border border-[var(--color-grid-line)]/70 transition-[border-radius,border-color] duration-300 ease-out",
          isStuck ? "rounded-b-[var(--radius-card)] border-t-0" : "rounded-[var(--radius-card)]",
        )}
      >
