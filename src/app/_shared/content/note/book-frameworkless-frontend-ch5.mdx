---
created: 2023-02-26 00:00:00 +0900
updated: 2023-08-22 00:39:12 +0900
title: "프레임워크 없는 프론트엔드 개발 (5)"
...
![model.png](./assets/book-frameworkless-ch5-model.png)
...
## 관련 문서
- [[react-data-fetching|리액트에서 데이터는 어떻게 가져와야 할까]]: 커스텀 훅과 API hook에서 데이터 요청 책임을 분리하는 맥락
