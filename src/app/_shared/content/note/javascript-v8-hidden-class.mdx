...
- 해시 테이블처럼 `O(1)`의 [[why-time-complexity|시간 복잡도]]를 갖지만, 히든 클래스는 상수가 거의 0에 근접하여 접근 비용이 매우 낮음
...
## 관련 문서
- [[hashtable-in-javascript|JavaScript Hash Table]]: 객체의 해시 기반 접근과 `Map` 선택 기준을 비교할 때 참고
