...
updated: 2026-01-26 00:54:03 +0900
title: 'ACP를 이용한 Neovim-Gemini CLI 통합'
tags: ["AI", "protocol", "agent"]
---
...
![zed-configure | size='540'](assets/2025-08-31-14-14-24.png)

**External Agents** 메뉴에서 Gemini CLI와 스레드를 시작하면 자동으로 설치되어 바로 이용할 수 있습니다.  

![gemini cli | size='540'](assets/2025-08-31-14-16-22.png)
...
제가 사용하는 Neovim에서도 [[codecompanion-basic|CodeCompanion]] 플러그인(v17.18.0 이상)을 통해 ACP를 지원합니다.
...
## 관련 문서
- [[claudecode-seoul-meetup-2025|Claude Code 서울 밋업 후기]]: Claude Code 워크플로우와 IDE 통합에 대한 후속 맥락
